/*
 * Copyright (c) 2004-2018 The YAWL Foundation. All rights reserved.
 ...
 * 
 * This class requires the YAWL openLDAP schema to be installed in the openLDAP 
 * server. 
 * 
...
public class LDAPSourceExtended extends DataSource {
    ...
    private void firstPass() throws NamingException {
        for (Map.Entry<LdapName, Attributes> node : _inputMap.entrySet()) {
            ...
            if (objectClasses.contains(OC_PARTICIPANT)) {
                ...
                OrgGroup orgGroup = createOrgGroup(node.getValue());
                ...
                Capability capability = createCapability(node.getValue());
                ...
                Position position = createPosition(node.getValue());
                ...
                Role role = createRole(node.getValue());
    ...
    private OrgGroup createOrgGroup(Attributes attr) throws NamingException {
        // Must attributes
    ...
    private Capability createCapability(Attributes attr) throws NamingException {
        // Must attributes
        String cn = getAttributeAsString(attr, ATTR_COMMON_NAME);
    ...
    private Position createPosition(Attributes attr) throws NamingException {
        // Must attributes
        String cn = getAttributeAsString(attr, ATTR_COMMON_NAME);
    ...
    private Role createRole(Attributes attr) throws NamingException {
        // Must attributes
        String cn = getAttributeAsString(attr, ATTR_COMMON_NAME);
